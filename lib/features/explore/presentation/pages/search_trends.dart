...
class SearchTrendsArgs {
  ...
  const SearchTrendsArgs({
    this.id,
  });
}

class SearchTrends extends StatefulWidget {
  static const String routeName = '/search-trends';
  const SearchTrends({
    Key? key,
    required this.id,
  }) : super(key: key);

  static Route route({required SearchTrendsArgs args}) {
...
class _SearchState extends State<SearchTrends> {
              ...
              child: Padding(
                ...
                child: TextField(
                  ...
                  decoration: textFormFieldDecoration.copyWith(
                    hintText: 'SearchTrends BlueBaker',
                  ...
                  onSubmitted: (value) {
                    if (_controller.text.trim().isNotEmpty) {
                      context
                          .read<SearchCubit>()
                          .searchBlueBaker(_controller.text.trim());
                    }
                  },
                ),
              ),
